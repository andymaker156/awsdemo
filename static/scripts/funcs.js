...
function initializeLoans() {
    ...
    la1.ApplicantName = "Howie Wesley";
    la1.ApplicantDateOfBirth = new Date(1985, 12, 1);
    la1.ApplicantAnnualIncome = 48000;
    la1.Factors = [false, true, true, false];
    la1.LoanPurpose = "I want to use this loan to build a new house";
    la1.LoanAmount = 150000;

    LoanApplicationList[0] = la1;

    var la2 = new LoanApplication();
    la2.ApplicantName = "Lydia Kimball M.D";
    la2.ApplicantDateOfBirth = new Date(1976, 5, 13);
    la2.ApplicantAnnualIncome = 218050;
    la2.Factors = [true, true, false, false];
    la2.LoanPurpose = "I need the loan to buy new equipment for my work";
    la2.LoanAmount = 4800;

    LoanApplicationList[1] = la2;

    var la3 = new LoanApplication();
    la3.ApplicantName = "Terry Millhouse";
    la3.ApplicantDateOfBirth = new Date(1948, 7, 20);
    ...
    la4.ApplicantName = "Roman Bennett";
    la4.ApplicantDateOfBirth = new Date(2008, 9, 2);
    la4.ApplicantAnnualIncome = 11000;
    la4.Factors = [false, false, true, false];
    la4.LoanPurpose = "Buy a new iPhone";
    la4.LoanAmount = 2000;

    LoanApplicationList[3] = la4;

    var la5 = new LoanApplication();
    la5.ApplicantName = "Calanthe Neville";
    la5.ApplicantDateOfBirth = new Date(1996, 7, 20);
    la5.ApplicantAnnualIncome = 120000;
    la5.Factors = [true, false, false, true];
    la5.LoanPurpose = "Purchase a new car for my business.";
    la5.LoanAmount = 40000;

    LoanApplicationList[4] = la5;
}

// create UUID for each application
...
// reload profile when page change
...
function generateRiskProfile(la) {
    ...
    if (age < 18) {
        ...
        return "Dear " + la.ApplicantName + ", " + reviewText;
    } else {
